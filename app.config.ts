...
export default ({ config }: ConfigContext): ExpoConfig => ({
  ...
  plugins: [
    ...
    [
      ...
      {
        // Provide safe dev fallbacks to avoid native crashes if env isn’t set locally.
        // Test App IDs from Google: https://developers.google.com/admob/ios/test-ads#sample_app_ids
        androidAppId:
  ...
  extra: {
    ...
    eas: {
      projectId: '48f8c4ca-a4f2-42c6-8a38-471524a90dcc',
    },

...
const badgeVariants = cva(
  'web:inline-flex items-center rounded-full border border-border px-2.5 py-0.5 web:transition-colors web:focus:outline-none web:focus:ring-2 web:focus:ring-ring web:focus:ring-offset-2',
  {
    variants: {
      variant: {
        default: 'border-transparent bg-primary web:hover:opacity-80 pressed:opacity-80',
        secondary: 'border-transparent bg-secondary web:hover:opacity-80 pressed:opacity-80',
        destructive: 'border-transparent bg-destructive web:hover:opacity-80 pressed:opacity-80',

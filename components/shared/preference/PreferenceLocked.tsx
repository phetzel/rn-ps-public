...
const PreferenceLocked: React.FC<PreferenceLockedProps> = ({ cabinetMemberName, relationship }) => {
  return (
    <View
    ...
    >
      <Lock className="h-4 w-4 text-gray-500" accessibilityLabel="Locked preference indicator" />

      <View className="flex-row items-center gap-2" accessible={false}>
        <Text className="text-base text-gray-500 font-medium" accessible={false}>
          Preference Locked
        </Text>

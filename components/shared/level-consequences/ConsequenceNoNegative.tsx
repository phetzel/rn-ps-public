  ...
  return (
    ...
    >
      <View className="flex-row items-center mb-2" accessible={false}>
        ...
        <Text className="text-base font-semibold">No Negative Consequences</Text>
      </View>
      <Text className="text-sm text-muted-foreground">
        Your performance maintained sufficient approval ratings. No significant consequences
        occurred this month.
      </Text>
    </View>
  );

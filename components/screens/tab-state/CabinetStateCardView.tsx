...
import type CabinetMember from '~/types/view-models/CabinetMember';

interface CabinetStateCardViewProps {
  cabinetMembers: CabinetMember[];
}

export function CabinetStateCardView({ cabinetMembers }: CabinetStateCardViewProps) {
  return (

...
import type SubgroupApproval from '~/types/view-models/SubgroupApproval';

interface SubgroupStateCardViewProps {
  subgroupApprovals: SubgroupApproval[];
}

export function SubgroupStateCardView({ subgroupApprovals }: SubgroupStateCardViewProps) {

...
import type { Level, Situation } from '~/types/view-models';

interface BriefingSituationsListViewProps {
  levelId: string;
...
export function BriefingSituationsListView({
  levelId: _levelId,
  situations,
  level,
  renderSituationPreferences,
}: BriefingSituationsListViewProps) {
  ...
  return (
    ...
    >
      ...
      >
        {renderSituationPreferences(currentSituation)}
      </ProgressNavigator>
    </View>
  );
}

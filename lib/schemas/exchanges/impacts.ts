...
export const exchangeImpactSchema = z
  .object({
...
export const exchangeImpactsSchema = z
  .object({
    president: exchangeImpactSchema.optional(),
    cabinet: z.record(z.nativeEnum(CabinetStaticId), exchangeImpactSchema).optional(),
    journalists: z.record(z.nativeEnum(JournalistStaticId), exchangeImpactSchema).optional(),
  })
  .strict();

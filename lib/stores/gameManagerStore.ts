...
import { createGameWithDetails, destroyGame, fetchGame } from '~/lib/db/helpers';
...
export const useGameManagerStore = create<GameManagerStoreState>((set, get) => ({
  // --- Initial State ---
  ...
  createAndStartGame: async (details: NewGameDetails): Promise<Game | null> => {

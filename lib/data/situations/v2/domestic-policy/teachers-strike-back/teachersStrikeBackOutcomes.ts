...
export const teachersStrikeBackOutcomes: SituationOutcome[] = [
  {
    ...
    description:
      "The administration quickly repeals the absurd mandate. Teachers declare victory and return to classrooms, ending the strike with a PR win for unions.",
    weight: 40,
    consequences: {
      approvalChanges: {
        cabinet: {
  ...
  },
  {
    ...
    description:
      "The administration digs in its heels, refusing to budge. The prolonged strike forces school closures, angering parents and harming students.",
    weight: 40,
    consequences: {
      approvalChanges: {
        cabinet: {
  ...
  },
  {
    ...
    description:
      "A compromise is reached: the mandate is dropped, but funding is increased for optional arts programs, including karaoke clubs. Both sides save face.",
    weight: 20,
    consequences: {
      approvalChanges: {
        cabinet: {

...
export const biometricDataLeakOutcomes: SituationOutcome[] = [
  {
    ...
    description:
      "The government acts decisively, patching the vulnerability and offering free credit monitoring to all citizens, largely preventing a wave of identity fraud.",
    weight: 30,
    consequences: {
      approvalChanges: {
        cabinet: {
  ...
  },
  {
    ...
    description:
      "The leaked data is immediately exploited by criminals. A massive wave of identity theft and fraud sweeps the nation, blaming government incompetence.",
    weight: 45,
    consequences: {
      approvalChanges: {
        cabinet: {
  ...
  },
  {
    ...
    description:
      "The administration's response is hampered by congressional inaction. No new funding or laws are passed, and public trust in the system erodes.",
    weight: 25,
    consequences: {
      approvalChanges: {
        cabinet: {

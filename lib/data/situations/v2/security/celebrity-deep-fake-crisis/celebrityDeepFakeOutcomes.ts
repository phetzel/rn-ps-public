...
export const celebrityDeepFakeOutcomes: SituationOutcome[] = [
  {
    ...
    description:
      "The crisis galvanizes bipartisan support for new laws regulating deep-fakes and AI-generated content, positioning the administration as a leader.",
    weight: 35,
    consequences: {
      approvalChanges: {
        cabinet: {
  ...
  },
  {
    ...
    description:
      "The administration fails to control the narrative. The public can't distinguish real from fake, leading to widespread distrust in all official communication.",
    weight: 45,
    consequences: {
      approvalChanges: {
        cabinet: {
  ...
  },
  {
    ...
    description:
      "Major tech platforms work with the government to quickly label and remove the fake videos, containing the spread and minimizing the damage.",
    weight: 20,
    consequences: {
      approvalChanges: {
        cabinet: {

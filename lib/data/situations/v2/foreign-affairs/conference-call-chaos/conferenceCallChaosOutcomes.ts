...
export const conferenceCallChaosOutcomes: SituationOutcome[] = [
  {
    ...
    description:
      "The technical glitch provides a moment of levity. Other leaders find it amusing, and the President's relatable moment is seen as a soft-power win.",
    weight: 40,
    consequences: {
      approvalChanges: {
        cabinet: {
  ...
  },
  {
    ...
    description:
      "The gaffe is perceived as a sign of incompetence. Global markets dip slightly as investors question the administration's seriousness and stability.",
    weight: 35,
    consequences: {
      approvalChanges: {
        cabinet: {
  ...
  },
  {
    ...
    description:
      "The incident spawns a viral 'Pirate President' meme. While embarrassing, it unexpectedly softens the President's image and makes them seem more human.",
    weight: 25,
    consequences: {
      approvalChanges: {
        subgroups: {

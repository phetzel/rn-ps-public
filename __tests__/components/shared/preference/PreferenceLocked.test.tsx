...
describe('PreferenceLocked', () => {
  ...
  it('renders Lock icon', () => {
    ...
    expect(screen.getAllByLabelText('Locked preference indicator').length).toBeGreaterThan(0);
  });
  ...
  it('tooltip trigger has proper accessibility hint', () => {
    ...
    expect(tooltipTrigger).toHaveProp('accessibilityHint', 'Additional information available');
  });
  ...
  it('handles different cabinet member names', () => {
    render(<PreferenceLocked cabinetMemberName="Bob Johnson" relationship={15} />);
  ...
  it('handles zero relationship', () => {
    render(<PreferenceLocked cabinetMemberName="Zero Person" relationship={0} />);
  ...
  it('handles negative relationship', () => {
    render(<PreferenceLocked cabinetMemberName="Negative Person" relationship={-10} />);
  ...
  it('handles names with special characters', () => {
    render(<PreferenceLocked cabinetMemberName="Mary O'Connor-Smith" relationship={33} />);

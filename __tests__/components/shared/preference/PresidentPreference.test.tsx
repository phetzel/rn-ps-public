...
describe("PresidentPreference", () => {
  beforeEach(() => {
    const { observeGame } = require("~/lib/db/helpers/observations");
  ...
  it("shows no preferences message when preference is undefined", () => {
    ...
    expect(
      screen.getByLabelText(
        "President has no specific preferences for this situation"
      )
    ).toBeTruthy();
  });
  ...
  it("shows preference content when available", () => {
    ...
    expect(
      screen.getByText(
        "The public needs reassurance during this difficult time"
      )
    ).toBeTruthy();
  });
  ...
  it("handles different answer types", () => {
    ...
    expect(
      screen.getByText(
        "This isn't the right time to address this issue directly"
      )
    ).toBeTruthy();
  });
  ...
  it("handles different president names from game data", () => {
    ...
    expect(
      screen.getByLabelText(
        "President Martinez's position on this situation: Transparency is key"
      )
    ).toBeTruthy();
  });
  ...
  it("handles empty rationale", () => {
    ...
    expect(
      screen.getByLabelText("President Johnson's position on this situation: ")
    ).toBeTruthy();
  });

...
describe('ConsequenceGameOver', () => {
  describe('when game ends due to firing', () => {
    it('should render firing message and styling', () => {
      ...
      expect(
        screen.getByText('The President has lost confidence in your abilities as Press Secretary.'),
      ).toBeTruthy();
    ...
    it('should have proper accessibility labels for firing', () => {
      ...
      expect(screen.getByLabelText('Game Over: Press Secretary fired by President')).toBeTruthy();
  ...
  describe('when game ends due to impeachment', () => {
    ...
    it('should have proper accessibility labels for impeachment', () => {
      ...
      expect(
        screen.getByLabelText('Game Over: Presidential impeachment due to low approval'),
      ).toBeTruthy();
      expect(screen.getByLabelText('Game Over status')).toBeTruthy();
    });
  });
  ...
  describe('visual styling', () => {
    it('should use amber styling for firing', () => {
      ...
      const { getByLabelText } = render(<ConsequenceGameOver consequences={consequences} />);

      // Check that the correct accessibility label is present (which implies correct styling)
      expect(getByLabelText('Game Over: Press Secretary fired by President')).toBeTruthy();
    });
    ...
    it('should use red styling for impeachment', () => {
      ...
      // Check that the correct accessibility label is present (which implies correct styling)
      expect(
        getByLabelText('Game Over: Presidential impeachment due to low approval'),
      ).toBeTruthy();
    });
  });
  ...
  describe('badge rendering', () => {
    it('should render GAME OVER badge for both scenarios', () => {
      ...
      const { rerender } = render(<ConsequenceGameOver consequences={firingConsequences} />);

...
describe("LevelConsequencesRiskCard", () => {
  ...
  describe("basic rendering", () => {
    it("should render risk assessment header", () => {
      ...
      expect(
        screen.getByText("Approval ratings and firing risk probabilities")
      ).toBeTruthy();
    });
  ...
  describe("accessibility", () => {
    it("should have proper accessibility labels for main card", () => {
      ...
      expect(
        screen.getByLabelText(
          "Risk assessment card. 2 cabinet members assessed."
        )
      ).toBeTruthy();
    });
    ...
    it("should have proper accessibility labels for presidential risks section", () => {
      ...
      expect(
        screen.getByLabelText("Presidential and Press Secretary risks")
      ).toBeTruthy();
    });
    ...
    it("should have proper accessibility labels for cabinet risks section", () => {
      ...
      expect(
        screen.getByLabelText(
          "Cabinet member firing risks: 2 members. 1 were fired this month."
        )
      ).toBeTruthy();
    });
  });
  ...
  describe("edge cases", () => {
    ...
    it("should handle multiple fired members", () => {
      ...
      expect(
        screen.getByLabelText(
          "Cabinet member firing risks: 2 members. 2 were fired this month."
        )
      ).toBeTruthy();
      // Check for fired badges by accessibility label
      expect(screen.getAllByLabelText("Cabinet member was fired")).toHaveLength(
        2
      );
    });
  });

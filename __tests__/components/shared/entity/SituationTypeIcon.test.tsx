...
describe("SituationTypeIcon", () => {
  it("renders domestic policy icon", () => {
    const { unmount } = render(
      <SituationTypeIcon type={SituationType.DomesticPolicy} />
    );
    expect(
      screen.getAllByLabelText("Domestic Policy situation type")[0]
    ).toBeTruthy();
    unmount();
  });
  ...
  it("renders foreign affairs icon", () => {
    const { unmount } = render(
      <SituationTypeIcon type={SituationType.ForeignAffairs} />
    );
    expect(
      screen.getAllByLabelText("Foreign Affairs situation type")[0]
    ).toBeTruthy();
    unmount();
  });
  ...
  it("renders economy icon", () => {
    const { unmount } = render(
      <SituationTypeIcon type={SituationType.Economy} />
    );
  ...
  it("renders with custom size", () => {
    const { unmount } = render(
      <SituationTypeIcon type={SituationType.Security} size={48} />
    );
  ...
  describe("handles all SituationType enum values", () => {
    it("renders environment icon", () => {
      const { unmount } = render(
        <SituationTypeIcon type={SituationType.Environment} />
      );
      expect(
        screen.getAllByLabelText("Environment situation type")[0]
      ).toBeTruthy();
      unmount();
    });
    ...
    it("renders ethics icon", () => {
      const { unmount } = render(
        <SituationTypeIcon type={SituationType.Ethics} />
      );
    ...
    it("renders governance icon", () => {
      const { unmount } = render(
        <SituationTypeIcon type={SituationType.Governance} />
      );
      expect(
        screen.getAllByLabelText("Governance situation type")[0]
      ).toBeTruthy();
      unmount();
    });
    ...
    it("renders security icon", () => {
      const { unmount } = render(
        <SituationTypeIcon type={SituationType.Security} />
      );
      expect(
        screen.getAllByLabelText("Security situation type")[0]
      ).toBeTruthy();
      unmount();
    });
  });
  ...
  describe("icon mapping", () => {
    it("assigns correct icons for all situation types", () => {
      Object.values(SituationType).forEach((type) => {
        ...
        const expectedLabel = `${formatAccessibilityLabel(
          type
        )} situation type`;
  ...
  describe("sizing", () => {
    it("uses default size when not specified", () => {
      ...
      expect(
        screen.getAllByLabelText("Economy situation type")[0]
      ).toBeTruthy();
      unmount();
    });
    ...
    it("accepts different custom sizes", () => {
      ...
      sizes.forEach((size) => {
        const { unmount } = render(
          <SituationTypeIcon type={SituationType.Security} size={size} />
        );
        expect(
          screen.getAllByLabelText("Security situation type")[0]
        ).toBeTruthy();

...
jest.mock(
  "~/components/shared/entity/PoliticalLeaningBadge",
  () =>
    ({ politicalLeaning }: any) => {
      const { Text } = require("react-native");
      return <Text>{politicalLeaning} Badge</Text>;
    }
);
  ...
  it("has accessibility label with president name and leaning", () => {
    ...
    expect(
      screen.getByLabelText(
        "President President Johnson, Liberal political leaning"
      )
    ).toBeTruthy();
  });

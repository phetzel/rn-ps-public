...
describe('SituationOutcomeExchangeImpactList', () => {
  ...
  it('highlights selected outcome with bold text', () => {
    ...
    expect(
      screen.getByLabelText('Crisis Escalation (current outcome): probability increased by 15%'),
    ).toBeTruthy();
  });
  ...
  it('shows non-selected outcomes without bold styling', () => {
    ...
    expect(
      screen.getByLabelText('Diplomatic Resolution: probability decreased by 10%'),
    ).toBeTruthy();
    expect(screen.getByLabelText('Economic Recovery: probability increased by 5%')).toBeTruthy();
  });
  ...
  it('has correct accessibility properties for container', () => {
    ...
    const container = screen.getByLabelText('Outcome impacts: 3 outcomes affected');
  ...
  it('handles single outcome impact', () => {
    ...
    const container = screen.getByLabelText('Outcome impacts: 1 outcomes affected');
    expect(container).toBeTruthy();

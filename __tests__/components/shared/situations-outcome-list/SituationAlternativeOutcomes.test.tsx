...
describe("SituationAlternativeOutcomes", () => {
  ...
  it("displays outcome descriptions", () => {
    ...
    expect(
      screen.getByText("The situation worsens and public confidence drops")
    ).toBeTruthy();
    expect(
      screen.getByText("A peaceful solution is found through negotiations")
    ).toBeTruthy();
    expect(
      screen.getByText("No significant change in the current situation")
    ).toBeTruthy();
  });

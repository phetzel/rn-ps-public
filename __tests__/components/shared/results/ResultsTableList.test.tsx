...
describe('ResultsTableList', () => {
  ...
  describe('empty/null data handling', () => {
    it('returns null when enhancedDeltas is null', () => {
      const result = render(<ResultsTableList {...defaultProps} enhancedDeltas={null} />);
    ...
    it('renders empty container when enhancedDeltas is empty', () => {
      ...
      expect(screen.queryByTestId('mocked-results-table-journalists')).toBeNull();
  ...
  describe('Admin section', () => {
    it('shows Admin section with president entities', () => {
      const entities = [createMockEntity('pres1', 'President Johnson', 'president')];
    ...
    it('shows Admin section with cabinet entities', () => {
      const entities = [createMockEntity('cab1', 'Secretary of Defense', 'cabinet')];
    ...
    it('does not show Admin section when no admin entities', () => {
      const entities = [createMockEntity('jour1', 'Reporter Smith', 'journalist')];
  ...
  describe('Journalists section', () => {
    it('shows Journalists section with journalist entities', () => {
      ...
      expect(screen.getByTestId('mocked-results-table-journalists')).toBeTruthy();
      expect(
        screen.getByText(
  ...
  describe('prop passing', () => {
    it('passes isAdWatched to all table components', () => {
      ...
      render(<ResultsTableList {...defaultProps} enhancedDeltas={entities} isAdWatched={true} />);
    ...
    it('passes showAdColumn to all table components', () => {
      ...
      render(<ResultsTableList {...defaultProps} enhancedDeltas={entities} showAdColumn={false} />);

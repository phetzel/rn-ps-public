...
describe('ResultsEntityRow', () => {
  ...
  describe('basic rendering', () => {
    ...
    it('renders entity name with accessibility label', () => {
      ...
      expect(screen.getByLabelText('Test Entity, Title for Test Entity')).toBeTruthy();
    });
    ...
    it('renders entity without title', () => {
      ...
      render(<ResultsEntityRow {...defaultProps} entity={entityWithoutTitle} />);
  ...
  describe('showAdColumn prop', () => {
    ...
    it('updates accessibility label when ad is watched', () => {
      render(<ResultsEntityRow {...defaultProps} isAdWatched={true} showAdColumn={true} />);
  ...
  describe('media data handling', () => {
    it('shows base column for media entity when showAdColumn is false', () => {
      ...
      render(<ResultsEntityRow entity={mediaEntity} isAdWatched={false} showAdColumn={false} />);
    ...
    it('does not show base column for media entity when showAdColumn is true', () => {
      ...
      render(<ResultsEntityRow entity={mediaEntity} isAdWatched={false} showAdColumn={true} />);
  ...
  describe('isAdWatched styling', () => {
    it('applies watched styling when ad is watched', () => {
      ...
      render(<ResultsEntityRow entity={entity} isAdWatched={true} showAdColumn={true} />);
    ...
    it('applies normal styling when ad is not watched', () => {
      ...
      render(<ResultsEntityRow entity={entity} isAdWatched={false} showAdColumn={true} />);
    ...
    it('applies normal styling when showAdColumn is false', () => {
      ...
      render(<ResultsEntityRow entity={entity} isAdWatched={true} showAdColumn={false} />);
  ...
  describe('edge cases', () => {
    ...
    it('renders without errors', () => {
      expect(() => render(<ResultsEntityRow {...defaultProps} />)).not.toThrow();
    });

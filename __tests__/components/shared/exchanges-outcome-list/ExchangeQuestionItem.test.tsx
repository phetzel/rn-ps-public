...
jest.mock(
  "~/components/shared/exchanges-outcome-list/ExchangeQuestionHeader",
  () => {
...
jest.mock(
  "~/components/shared/exchanges-outcome-list/ExchangeQuestionAnswer",
  () => {
...
describe("ExchangeQuestionItem", () => {
  ...
  const mockJournalistStaticId: JournalistStaticId =
    "journalist_sarah_chen" as JournalistStaticId;

...
describe("LevelMediaCoverageContent", () => {
  ...
  it("renders table with correct accessibility label", () => {
    ...
    expect(
      screen.getByLabelText(
        "Media publications table with 3 publications and total boost of 1.17"
      )
    ).toBeTruthy();
  });
  ...
  it("renders table headers correctly", () => {
    ...
    expect(
      screen.getByLabelText(
        "Table headers: Publication name, Approval rating, Boost multiplier"
      )
    ).toBeTruthy();
  ...
  it("has accessibility labels for each publication row", () => {
    ...
    expect(
      screen.getByLabelText(
        "Daily Liberal: 75% approval, boost multiplier 1.25"
      )
    ).toBeTruthy();
    expect(
      screen.getByLabelText(
        "Conservative Times: 25% approval, boost multiplier 0.75"
      )
    ).toBeTruthy();
    expect(
      screen.getByLabelText("Neutral News: 50% approval, boost multiplier 1.00")
    ).toBeTruthy();
  });
  ...
  it("renders total media impact row", () => {
    ...
    expect(
      screen.getByLabelText("Total media impact: boost multiplier of 1.17")
    ).toBeTruthy();
  });
  ...
  it("handles empty media boosts array", () => {
    ...
    expect(
      screen.getByLabelText(
        "Media publications table with 0 publications and total boost of 1.00"
      )
    ).toBeTruthy();
    expect(screen.getByText("Total Media Impact")).toBeTruthy();
    expect(screen.getByText("x1.00")).toBeTruthy();
  ...
  it("handles single publication correctly", () => {
    ...
    render(
      <LevelMediaCoverageContent mediaBoosts={singleBoost} totalBoost={1.25} />
    );

    expect(
      screen.getByLabelText(
        "Media publications table with 1 publications and total boost of 1.25"
      )
    ).toBeTruthy();
    expect(screen.getByText("Daily Liberal")).toBeTruthy();
  });
  ...
  it("formats decimal totalBoost correctly", () => {
    ...
    expect(
      screen.getByLabelText(
        "Media publications table with 3 publications and total boost of 1.12"
      )
    ).toBeTruthy();
  ...
  it("handles zero approval rating", () => {
    ...
    expect(
      screen.getByLabelText(
        "Zero Approval Pub: 0% approval, boost multiplier 0.50"
      )
    ).toBeTruthy();
  });

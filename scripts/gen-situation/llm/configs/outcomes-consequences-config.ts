...
- Return an object with outcomeConsequences: an array where each item preserves the original outcomeId
- Provide ONLY: consequences.approvalChanges.{ cabinet?, subgroups? }
- Do not re-emit or alter id, title, description, or weight (you will receive base outcomes separately)
- Only provide consequences mapped by outcomeId

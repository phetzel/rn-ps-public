...
export class OutcomesBaseSubstep extends ResponsesGenerationStep<
  OutcomesBaseInput,
  GenerateBaseOutcomes
> {
  ...
  protected async transform(
    result: GenerateBaseOutcomes,
    _input: OutcomesBaseInput,
  ): Promise<GenerateBaseOutcomes> {
